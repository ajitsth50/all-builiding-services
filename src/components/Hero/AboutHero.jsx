  ...
  return (
    <section className="relative overflow-hidden bg-white">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute right-[-20%] top-0 h-[120%] w-[60%] rotate-6 bg-gradient-to-b from-sky-50 to-white" />
        <div className="absolute left-1/2 top-[20%] h-[36rem] w-[36rem] -translate-x-1/2 rounded-full bg-sky-500/10 blur-3xl" />
      </div>
      ...
      <div className="mx-auto grid min-h-[680px] max-w-7xl grid-cols-1 items-center gap-10 px-6 pt-32 pb-20 sm:px-10 lg:grid-cols-12 lg:gap-12">
        <div className="order-2 lg:order-1 lg:col-span-6">
          ...
          >
            <motion.span
              variants={fade(0.05)}
              className="inline-flex items-center rounded-full border border-sky-600/25 bg-sky-50 px-3 py-1 text-[12px] font-semibold tracking-[0.18em] uppercase text-sky-700"
            >
              About us
            </motion.span>
            ...
            <motion.p
              variants={fade(0.18)}
              className="mt-5 text-lg leading-8 text-gray-800"
            >
            ...
            >
              <Link
                href="/services"
                className="inline-flex items-center justify-center gap-2 rounded-full bg-sky-600 px-6 py-3 text-base font-semibold text-white shadow-sm ring-1 ring-inset ring-sky-600/20 transition hover:bg-sky-700"
              >
                View services
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-6 py-3 text-base font-semibold text-gray-900 shadow-sm transition hover:bg-gray-50"
              >
                Get a quote
              </Link>
            </motion.div>
        ...
        <div className="order-1 lg:order-2 lg:col-span-6">
          ...
          >
            <div className="relative overflow-hidden rounded-3xl border border-gray-200 shadow-xl ring-1 ring-black/5">
              <video
                src={heroVideo}
                autoPlay
                loop
