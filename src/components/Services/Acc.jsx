...
const FAQS = [
  {
    qIcon: <FaTools className="text-sky-50" />,
  ...
  {
    qIcon: <FaTint className="text-sky-50" />,
  ...
  {
    qIcon: <FaHardHat className="text-sky-50" />,
  ...
  {
    qIcon: <FaShieldAlt className="text-sky-50" />,
  ...
  {
    qIcon: <FaStopwatch className="text-sky-50" />,
    ...
    <section className="py-16 bg-white">
      <div className="mx-auto max-w-screen-md px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          <p className="mt-1 text-xs font-semibold tracking-[0.18em] uppercase text-sky-700">
            F.A.Q
          </p>
          ...
          {FAQS.map((item, i) => (
            <li key={item.q} className="text-left">
              ...
              <div className="flex items-start mb-4">
                <div className="hidden sm:flex items-center justify-center p-3 mr-3 rounded-full bg-sky-600 text-white border-4 border-white shadow-sm">
                  {item.qIcon}
                </div>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between rounded-xl border border-gray-200 bg-gray-50 px-6 py-5 text-left transition hover:bg-gray-100"
                >
                  <span className="flex items-center gap-3">
                    {/* Mobile icon */}
                    <span className="sm:hidden inline-flex items-center justify-center p-2 rounded-full bg-sky-600 text-white">
                      {item.qIcon}
                    </span>
                  ...
                  <FaChevronDown
                    className={`ml-4 h-5 w-5 text-sky-700 transition-transform ${
                      open === i ? "rotate-180" : ""
                    }`}
                  />
                </button>
              ...
              {/* Answer Row */}
              <div
                className={`w-full rounded-xl border border-sky-600/15 bg-sky-50 px-6 py-5 shadow-sm transition-all duration-300 ${
                  open === i
        ...
        {/* Footer */}
        <p className="mt-10 text-center text-gray-700 text-sm sm:text-base">
          Still have questions?{" "}
          <a
            href="tel:+61272293522"
            className="inline-flex items-center gap-2 underline decoration-sky-400 underline-offset-4 hover:text-gray-900"
          >
          ...
          <a
            ...
            className="underline decoration-sky-400 underline-offset-4 hover:text-gray-900"
          >
            email our team
          </a>
          .
